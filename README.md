...
사용자 문제를 발견하고 서비스로 만들어온 프론트엔드 개발자입니다.
핀테크 도메인에서 기획부터 배포까지 경험했습니다.

**Stack** — React · JavaScript/TypeScript · Git/GitHub Actions
...
- **미래에셋증권 AI 페스티벌 참가** — 팀명 ChainDrifters로 지원
- 담당: 프론트엔드 (React/TypeScript), 로고 제작
...
### [Jobtology](https://github.com/SMU-GoodEyeDeer)
 Team Goodeyedeer GraphRAG 기반 인과관계 분석으로 학생들의 진로를 추천하는 AI 서비스 — 진행 중
...
- **2026 · Chaindrifter** — 핀테크 도메인 진입, KFIP 2026 본선, FIN:NECT 2026 지역예선, 미래에셋증권 AI 페스티벌 참가(팀명 ChainDrifters)
- **2026~ · Goodeyedeer** — 졸업 프로젝트, GraphRAG 추천 결과를 시각화하는 프론트엔드 (진행 중)
